...
PingppResource.prototype = {
  ...
  _request: function(method, path, data, auth, callback) {
    ...
    if ((method == 'POST' || method == 'PUT') && requestData != '' && this._pingpp.getPrivateKey()) {
      headers['Pingplusplus-Signature'] = utils.generateSign(requestData, this._pingpp.getPrivateKey());
    }
